...
Mooncite 4.0.4 is distributed from the tagged GitHub repository, not the npm registry.
...
The installer also creates `~/.local/bin/mooncite` as an exact link to the stable CLI. It refuses to replace an unrelated command at that path.
